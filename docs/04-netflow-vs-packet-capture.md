...
|---------|---------|------|
| "Is there unusual outbound traffic?" | ✅ | Could work |
| "What are our top talkers?" | ✅ | Overkill |
| "Is this host beaconing?" | ✅ | Possible |
| "What was in the HTTPS transfer?" | ❌ | Requires TLS inspection |
| "What malware C2 protocol is this?" | ❌ | ✅ |
| "Was a password sent in clear text?" | ❌ | ✅ |
