...
# Internal subnet prefix to exclude — adjust to match your environment
...
def normalize(r):
    # Support both pmacctd timestamp field names
    ...
    return {
        ...
        "nf_src_port": str(r.get("port_src", 0)),
        "nf_dst_port": str(r.get("port_dst", 0)),
        "nf_protocol": r.get("ip_proto", "unknown"),
        "nf_packets":  str(r.get("packets", 0)),
        "nf_bytes":    str(r.get("bytes", 0)),
        "nf_duration": str(calc_duration(t1, t2))
    }
